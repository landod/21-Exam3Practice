...
def run_test_zero_changer():
    ...
    test1 = ([8, 4, 0, 9], [77, 0, 0, 1, 5, 0], [4, 4, 4], [4, 0, 4, 0, 0, 0, 0, 0])
    expected1 = ([8, 4, 1, 9], [77, 2, 3, 1, 5, 4], [4, 4, 4], [4, 5, 4, 6, 7, 8, 9, 10])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
    ...
    test1 = ([8, 4, 0, 9], [77, 0, 0, 1, 5, 0], [4, 4, 4], [4, 0, 4, 6, 9, 1, 0, 2, 3])
    expected1 = ([8, 4, 1, 9], [77, 2, 3, 1, 5, 4], [4, 4, 4], [4, 5, 4, 6, 9, 1, 6, 2, 3])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
